...
detail:
  ...
  meta:
    - label: Müşteri
      value: Annelik & Ebeveynlik İçerik Platformu
    - label: Kapsam
      value: Marka Kimliği + Dijital Ürün
    - label: Hizmetler
  ...
  approach:
    ...
    text: |-
      Markanın el yazısı logosuyla başladık: içindeki kalp figürü ve akışkan çizgiler anneliğin duygusunu taşırken, mor palet platformu kategorideki jenerik pembe-mavi klişesinden ayırıyor.

      Bu kimliği önce web sitesine taşıdık. Hamilelik haftaları, ay ay bebek gelişimi ve ebeveynlik rehberleri gibi derin içerik havuzunu; annenin bulunduğu aşamaya göre gezinebileceği araç ve kategori yapılarıyla düzenledik.

      Ardından aynı dili mobil uygulamaya, sosyal medya içeriklerine ve video prodüksiyonuna genişlettik. 404 sayfasındaki ağlayan bebek illüstrasyonuna kadar her detayda markanın sıcak tonunu koruduk.
  sections:
    - heading: Logo & Marka Kimliği
      text: |-
        Marka için el yazısı bir logotype tasarladık; "an" ve "nelik" hecelerinin üzerine oturan kalp figürü markanın duygusal merkezini oluşturuyor.
    ...
    - heading: Web Sitesi & Mobil Uygulama
      text: |-
        ...
        Haftalık gebelik takibini görsel bir zaman çizelgesine dönüştürdük; anne kendi haftasını seçip o döneme ait içeriklere doğrudan ulaşabiliyor. Bebek ve ebeveynlik kategorilerinde ise içerik listeleri kart yapısıyla taranabilir hâle getirildi.
...
Anne ve kadın odaklı içerik platformu için sıcak, renkli ve sosyal medyada ayırt edilen bir marka dünyası.
