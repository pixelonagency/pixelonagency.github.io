# PIXELON SEO — DAILY SUMMARY · 2026-08-27

> Toplam/anonim metrikler. Sorgu, sıralama ve fırsat detayı **bilinçli olarak** dışarıda
> bırakılmıştır — repo public. Detay: `seo/private/reports/DAILY-2026-08-27.md` (yalnızca yerel).

```text
Organic clicks:            19
Organic impressions:       1334
CTR:                       1.42%
Average position:          28.8
Measured window:           28 gün
Indexed URLs:              109
Technical errors (P0/P1):  0/0
Orphan pages:              0
Broken internal links:     0
High-priority opportunities: 26
Approval queue:            0
Checks run:                0
Checks OK:                 0
