# PIXELON SEO — WEEKLY SUMMARY · 2026-09-01

> Toplam/anonim metrikler. Sorgu, sıralama ve fırsat detayı **bilinçli olarak** dışarıda
> bırakılmıştır — repo public. Detay: `seo/private/reports/WEEKLY-2026-09-01.md` (yalnızca yerel).

```text
Organic clicks:            15
Organic impressions:       1701
CTR:                       0.88%
Average position:          24.9
Measured window:           7 gün
Indexed URLs:              109
Technical errors (P0/P1):  0/0
Orphan pages:              0
Broken internal links:     0
High-priority opportunities: 38
Approval queue:            0
Checks run:                13
Checks OK:                 9
