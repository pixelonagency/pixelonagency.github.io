# PIXELON SEO — DAILY SUMMARY · 2026-08-28

> Toplam/anonim metrikler. Sorgu, sıralama ve fırsat detayı **bilinçli olarak** dışarıda
> bırakılmıştır — repo public. Detay: `seo/private/reports/DAILY-2026-08-28.md` (yalnızca yerel).

```text
Organic clicks:            20
Organic impressions:       1621
CTR:                       1.23%
...
High-priority opportunities: 30
Approval queue:            0
Checks run:                0
Checks OK:                 0
