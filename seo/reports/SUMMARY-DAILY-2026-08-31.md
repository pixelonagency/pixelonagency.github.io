# PIXELON SEO — DAILY SUMMARY · 2026-08-31

> Toplam/anonim metrikler. Sorgu, sıralama ve fırsat detayı **bilinçli olarak** dışarıda
> bırakılmıştır — repo public. Detay: `seo/private/reports/DAILY-2026-08-31.md` (yalnızca yerel).

```text
Organic clicks:            26
Organic impressions:       2372
CTR:                       1.1%
...
High-priority opportunities: 36
Approval queue:            0
Checks run:                0
Checks OK:                 0
