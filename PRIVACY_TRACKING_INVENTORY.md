...
| Meta Pixel             | **Planned / Not Active** | advertising measurement, conversion measurement, marketing attribution, audience measurement (hazırlık tamam; production doğrulaması yapılmadan Active yazılmaz) | Marketing (Klaro `meta-pixel`)                         | Beklenen: `_fbp` (1. taraf; `_fbc` yalnız fbclid senaryosunda olabilir) — canlıda gözlemlenince işlenir; izin yokken HİÇBİR Meta isteği/çerezi olmaz                                                              | reklam/dönüşüm                                                             | Meta (Pixel/Dataset: `1096159972333769`) | Evet                             | Aktivasyondan önce                                       | —              |
